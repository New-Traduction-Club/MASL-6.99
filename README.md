# MASL: 6.99 Edition (Unofficial Android Port)
...
> 
> **1. UNOFFICIAL PROJECT:** This is a strictly unofficial, fan-made Android wrapper/launcher. It is not affiliated with, endorsed by, or associated with Team Salvato or the official MAS team. 
>
...
MASL is a custom-engineered Android port designed to run the Monika After Story mod seamlessly on mobile environments. Rather than distributing copyrighted material, this project provides a robust, optimized launcher based on a customized fork of Ren'Py's RAPT (Ren'Py Android Packaging Tool).
...
* **[MAS Team](https://www.monikaafterstory.com/):** For the original mod and their continuous hard work.
...
This is a special build of MASL using Ren'Py 6.99.
